...
| Plan | Title                                                | Priority | Effort | Depends on | Status |
|------|------------------------------------------------------|----------|--------|------------|--------|
| 013  | Cache compute bind group across frames              | P2       | S      | —          | TODO |
| 014  | Upload star catalogue only when dirty               | P2       | S      | —          | TODO |
| 015  | Clear `needs_render` in stars-only 3D mode           | P2       | S      | —          | TODO |
| 016  | Remove dead `instance_count` field from GpuStars     | P3       | S      | —          | TODO |
| 017  | Split `main.rs` monolith into modules               | P2       | L      | 013,014,015 | TODO |
| 018  | Add `generate_star_catalogue` characterization tests | P1       | M      | —          | TODO |
| 019  | Handle surface format in display shader              | P3       | S      | —          | TODO |
| 020  | Name camera and orbit magic numbers                  | P3       | S      | 017        | TODO |
| 021  | Preset cross-fade transition                         | P3       | M      | —          | TODO |
| 022  | Dust extinction in the ray-march path                | P3       | S      | —          | TODO |
| 023  | Add iconic galaxy presets (M31, M51, M101)           | P3       | M      | —          | TODO |
